...
# echo '<ol>' >> $dir$orderNum.html;
# for sapNum in ${orderString[@]};do
# echo  "<li><iframe id='$sapNum' src='https://praktiker.bg/p/$sapNum#globalMessages' height='400' width='300' title='$sapNum'></iframe><input type='checkbox' value='1'/><div class='top'><a href='#top'>TOP</a></div></li></br><hr>" >> $dir$orderNum.html;
# done
# echo '</ol>' >> $dir$orderNum.html;
